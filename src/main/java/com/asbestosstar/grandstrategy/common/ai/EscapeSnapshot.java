 ...
 */
public record EscapeSnapshot(int originX, int originY, int originZ, int width, int height, int depth, byte[] voxels,
		int startX, int startY, int startZ, int directionX, int directionZ) {
