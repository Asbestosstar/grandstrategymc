...
public final class PlayerCountryService {
    ...
    public static boolean declareWar(String sourceId, String targetId) {
        // Legacy entry point retained for old clients/commands. A declaration now
        // requires a previously justified war goal, so this cannot bypass the new
        // diplomacy screen by paying the obsolete flat 25-PP declaration cost.
        return DiplomacySystem.handleAction(sourceId, targetId,
                DiplomacySystem.DECLARE_WAR, 0L);
    }
