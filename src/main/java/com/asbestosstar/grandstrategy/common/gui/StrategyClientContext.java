...
public final class StrategyClientContext {
    ...
    public static boolean requestDiplomacy(String target, String action) {
        return NetworkManager.getInstance().requestDiplomacy(target, action, null);
    }
    public static boolean requestDiplomacy(String target, String action, String argument) {
        return NetworkManager.getInstance().requestDiplomacy(target, action, argument);
    }
