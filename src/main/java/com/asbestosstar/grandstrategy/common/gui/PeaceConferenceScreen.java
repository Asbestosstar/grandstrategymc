...
public final class PeaceConferenceScreen extends StrategyScreen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(Component.literal("Territory (25)"), button ->
                        propose(territoryTerms))
                .bounds(18, y, 132, 20).build());
        y += 24;

        this.addRenderableWidget(Button.builder(Component.literal("Puppet (65)"), button ->
        ...
        this.addRenderableWidget(Button.builder(Component.literal("Territory + Puppet (85)"), button ->
    ...
    protected void renderCustom(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(this.font,
                own.getName() + " vs " + opponent.getName() + " | Your war score: "
