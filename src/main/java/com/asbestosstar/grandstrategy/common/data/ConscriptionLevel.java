...
public enum ConscriptionLevel {
    VOLUNTEER_ONLY("Volunteer Only", 0.02),
    LIMITED_CONSCRIPTION("Limited Conscription", 0.10),
    EXTENSIVE_CONSCRIPTION("Extensive Conscription", 0.20),
    SERVICE_BY_REQUIREMENT("Service by Requirement", 0.35),
