...
public class Leader {
	...
	public Leader(String id, String name, boolean immortal, List<String> traits, String religionId,
			String snapReligionId, String ideologyId, String snapIdeologyId, double religiousExtremism,
			double ideologicalExtremism) {
		this.id = id;
		this.name = name;
	...
	public List<String> getTraits() {
		return traits == null ? List.of() : List.copyOf(traits);
	}
	...
	public String getSnapReligionId() {
		return snapReligionId;
	}

	public String getIdeologyId() {
		return ideologyId;
	}

	public String getSnapIdeologyId() {
		return snapIdeologyId;
	}

	public double getReligiousExtremism() {
		return clamp(religiousExtremism);
	}

	public double getIdeologicalExtremism() {
		return clamp(ideologicalExtremism);
	}
	...
	public void setIdeologyId(String ideologyId) {
		this.ideologyId = ideologyId;
	}

	public void setReligiousExtremism(double value) {
		religiousExtremism = clamp(value);
	}

	public void setIdeologicalExtremism(double value) {
		ideologicalExtremism = clamp(value);
	}
