...
public class FactoryType {
	...
	public FactoryType(String id, String name, String description, List<String> capabilities,
			List<String> requiredTechnologyIds, List<String> requiredItemIds, boolean starter) {
		this.id = id;
		this.name = name;
	...
	public boolean hasCapability(String capability) {
		if (capability == null || capabilities == null)
			return false;
