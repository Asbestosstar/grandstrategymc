...
public class City {
    ...
    public City(String id, String name, int blockX, int blockZ, String controllerId,
                boolean nationalCapital, boolean supplyCapital) {
        this.id = id;
        this.name = name;
        this.blockX = blockX;
        this.blockZ = blockZ;
    ...
    public boolean isNationalCapital() { return nationalCapital; }
    public boolean isSupplyCapital() { return supplyCapital; }
    public int getCommandPostY() { return commandPostY; }
    public boolean hasCommandPostPosition() { return commandPostY != Integer.MIN_VALUE; }
    ...
    public void setCommandPostY(int commandPostY) { this.commandPostY = commandPostY; }
    public void clearCommandPostPosition() { this.commandPostY = Integer.MIN_VALUE; }
    public void setControllerId(String controllerId) { this.controllerId = controllerId; }
    public void setNationalCapital(boolean nationalCapital) { this.nationalCapital = nationalCapital; }
    public void setSupplyCapital(boolean supplyCapital) { this.supplyCapital = supplyCapital; }
}
