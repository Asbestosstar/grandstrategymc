...
public class StrategyEffect {
	public enum Type {
		RESOURCE, POLITICAL_POWER, STABILITY, RESEARCH, POPULATION, FACTORIES, ROADS, NATIONAL_SPIRIT,
		REMOVE_NATIONAL_SPIRIT, GOVERNMENT, CONSCRIPTION, RELATION_NEAREST
	}
	...
	public static StrategyEffect spirit(NationalSpirit spirit) {
		return new StrategyEffect(Type.NATIONAL_SPIRIT, spirit == null ? null : spirit.getId(), 1.0);
	}

	public static StrategyEffect removeSpirit(NationalSpirit spirit) {
		return new StrategyEffect(Type.REMOVE_NATIONAL_SPIRIT, spirit == null ? null : spirit.getId(), 1.0);
	}
