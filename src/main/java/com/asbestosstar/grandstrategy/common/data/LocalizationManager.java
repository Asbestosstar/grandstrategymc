...
public class LocalizationManager {
    ...
    static {
        ...
        // Initialize Spanish (MX) - Using British English equivalent standards where requested
    ...
    public static String translate(String key) {
        return TRANSLATIONS.getOrDefault(currentLanguage, TRANSLATIONS.get("en_gb"))
