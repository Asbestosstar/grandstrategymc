...
public final class DefaultRegistry {
    ...
    private static void registerIdeologies() {
        ...
        putIdeology(new Ideology("corporatism", "Corporatism", "corporatist", null, "oligarchy",
                1880, List.of("industrialisation"), Map.of("factory", 0.10, "stability", 0.03), Map.of(), false));
    }
    ...
    private static void registerTechnologiesAndIndustry() {
        ...
        putTechnology(tech("special_military_operations", "Special Military Operations",
                "Doctrine for politically limited military operations against corporatist states. Base year 2025; Russia receives an explicit early-2022 research advantage.",
                2025, 2040, 420,
