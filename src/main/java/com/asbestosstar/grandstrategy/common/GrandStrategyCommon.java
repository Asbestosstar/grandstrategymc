 ...
 *
 * Mod-loader initialisation must remain lightweight: no world state is loaded
 * and no simulation threads are started until a MinecraftServer is actually
 * running a world.
 */
public final class GrandStrategyCommon {
	...
	/**
	 * Called by Fabric/Forge/NeoForge/FeatureCreep during mod discovery. This
	 * deliberately does not load world data or start the strategy engine.
	 */
